...
SLEEP_TIME  = 0.05    # seconds between windows — reduce to 0.01 to speed up
...
X_feat = data['X_feat']    # HRV features (N, 13)
X_seq  = data['X_seq']     # RR sequences (N, 30)
y      = data['y']         # labels 0=Normal 1=AFib
...
for i in range(len(y)):
    window_rr  = X_seq[i]       # raw RR sequence (30,)
    feat       = X_feat[i]      # HRV features   (13,)
    true_class = int(y[i])      # ground truth
